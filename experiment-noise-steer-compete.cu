...
int main(){
    ...
    for(int tr=0;tr<TRIALS;tr++){
        ...
        simulate<<<blk,BLK>>>(d_sa,d_sb,d_fx,d_fy,d_fa,STEPS,NF,FOOD,W,(unsigned int)(42+tr*1111));
    ...
    ta/=TRIALS;tb/=TRIALS;
    printf("Steer(A): %.3f  Noise(B): %.3f  ratio: %.2f\n",ta,tb,ta/(tb+0.001f));
    printf("\n>> Law 247: Steering vs noise head-to-head\n");
