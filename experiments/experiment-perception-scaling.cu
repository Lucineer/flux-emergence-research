...
int main(){
    ...
    printf("=== Perception Range Scaling (No Coordination) ===\\n");
    printf("4096 agents, 400 food, 2000 steps\\n");
    int grabs[]={2,4,6,8,12,16,24,32,48,64};
    for(int gi=0;gi<10;gi++){
        cudaMemcpyToSymbol(grab_r,&grabs[gi],sizeof(int));
